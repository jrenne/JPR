...
<a class="btn btn-primary" href="https://www.cairn.info/revue-economie-et-prevision-2007-1-page-129.htm3" role="button" target="_blank" style="padding: 5px 5px;">Link to journal's website</a>
</div>
```

```{=html}
<div  style="margin: 30px; text-align: center;">
<a class="btn btn-primary" href="2007-004-10en.pdf" role="button" target="_blank" style="padding: 5px 5px;">English version</a>
</div>
```
