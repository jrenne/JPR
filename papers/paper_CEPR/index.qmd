...
```{=html}
<div  style="margin: 30px; text-align: center;">
<a class="btn btn-primary" href="https://eabcn.org/paper/economic-activity-g7-synchronized-common-shocks-versus-spillover-effects" role="button" target="_blank" style="padding: 5px 5px;">Link to EABCN website</a>
</div>
```
