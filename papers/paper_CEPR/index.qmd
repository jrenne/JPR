...
<a class="btn btn-primary" href="https://cepr.org/publications/dp4119" role="button" target="_blank" style="            display: inline-block;
            padding: 10px 20px;
            ...
            color: #333;
            margin: 0 10px;
            font-size: 16px;">Link to paper (CEPR website)</a>
<a class="btn btn-primary" href="https://eabcn.org/paper/economic-activity-g7-synchronized-common-shocks-versus-spillover-effects" role="button" target="_blank" style="            display: inline-block;
            padding: 10px 20px;
            border: 2px solid #333;
            border-radius: 20px;
            background-color: #f1f1f1;
            ...
            color: #333;
            margin: 0 10px;
            font-size: 16px;">Link to paper (EABCN website)</a>
</div>
```
