...
<a class="btn btn-primary" href="https://doi.org/10.1016/j.jbankfin.2024.107131" role="button" target="_blank" style="            display: inline-block;
            padding: 10px 20px;
...
<a class="btn btn-primary" href="https://github.com/jrenne/GDP_LB" role="button" target="_blank" style="            display: inline-block;
            padding: 10px 20px;
            border: 2px solid #333;
            border-radius: 20px;
            background-color: #f1f1f1;
