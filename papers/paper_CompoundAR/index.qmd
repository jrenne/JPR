...
<a class="btn btn-primary" href="https://www.cambridge.org/hn/universitypress/subjects/economics/macroeconomics-and-monetary-economics/developments-macro-finance-yield-curve-modelling" role="button" target="_blank" style="padding: 5px 5px;">Link to book</a>
</div>
```

```{=html}
<div  style="margin: 30px; text-align: center;">
<a class="btn btn-primary" href="Monfort_Renne_chapter.pdf" role="button" target="_blank" style="padding: 5px 5px;">Link to paper</a>
</div>
```
