...
date: "8/12/2025"
categories: [term structure, climate risks, published]
image: "figure.pdf"
---
...
<a class="btn btn-primary" href="https://www.econometricsociety.org/publications/quantitative-economics/forthcoming-papers" role="button" target="_blank" style="            display: inline-block;
            padding: 10px 20px;
...
<a class="btn btn-primary" href="https://zenodo.org/records/16740066" role="button" target="_blank" style="            display: inline-block;
            padding: 10px 20px;
            border: 2px solid #333;
            border-radius: 20px;
            background-color: #f1f1f1;
